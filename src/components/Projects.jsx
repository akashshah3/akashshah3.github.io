                        ...
                        <Card className="flex flex-col gap-3 hover:bg-stone-50 transition-colors border-stone-200/60 h-full">
                            ...
                            <div className="flex flex-wrap gap-1 mt-auto">
                                {project.techStack.map((tech) => (
                                    <Badge key={tech} variant="secondary" className="text-[10px] px-1.5 py-0 bg-stone-100 text-stone-600 border-stone-200">
                                        {tech}
                                    </Badge>
                                ))}
                            </div>
                            ...
                            <div className="flex gap-2 pt-2 mt-auto">
                                {project.links.map((link) => (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="inline-flex items-center gap-2 text-xs font-medium px-3 py-1.5 rounded-md transition-all
                                        bg-stone-900 text-stone-50 hover:bg-stone-800 hover:scale-105 active:scale-95 shadow-sm"
                                    >
